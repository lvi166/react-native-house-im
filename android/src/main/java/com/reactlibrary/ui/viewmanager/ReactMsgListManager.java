package com.reactlibrary.ui.viewmanager;
...
import com.reactlibrary.ui.CustomViewHolder;
import com.reactlibrary.ui.IdHelper;
import com.reactlibrary.ui.event.LoadedEvent;
import com.reactlibrary.ui.event.MessageEvent;
import com.reactlibrary.ui.event.OnTouchMsgListEvent;
import com.reactlibrary.ui.event.ScrollEvent;
import com.reactlibrary.ui.event.StopPlayVoiceEvent;
import com.reactlibrary.ui.messagelist.commons.ImageLoader;
import com.reactlibrary.ui.messagelist.commons.models.IMessage;
import com.reactlibrary.ui.messagelist.messages.CustomMsgConfig;
import com.reactlibrary.ui.messagelist.messages.MessageList;
import com.reactlibrary.ui.messagelist.messages.MsgListAdapter;
import com.reactlibrary.ui.messagelist.messages.ViewHolderController;
import com.reactlibrary.ui.messagelist.messages.ptr.PtrDefaultHeader;
import com.reactlibrary.ui.messagelist.messages.ptr.PtrHandler;
import com.reactlibrary.ui.messagelist.messages.ptr.PullToRefreshLayout;
import com.reactlibrary.ui.messagelist.utils.DisplayUtil;
import com.reactlibrary.ui.model.RCTMessage;
...
public class ReactMsgListManager extends ViewGroupManager<PullToRefreshLayout> implements SensorEventListener {
    ...
    private static final String TAG = "ReactMsgListManager";
...
//
//                }else {//更新插入多条
                    RCTMessage[] updateS = event.getMessages();

                Log.d(TAG, "onEvent: "+updateS.length);

                    for (final RCTMessage rctMessage : updateS) {

                        Log.d("RCTMessageListManager", "Add message to start, message: " + rctMessage);
                        if (activity != null) {

                            if (mAdapter.getItemExist(rctMessage.getMsgId())){
                                mAdapter.updateMessage(rctMessage.getMsgId(), rctMessage);
                            }else {
                                mAdapter.addToStart(rctMessage, true);
                            }
