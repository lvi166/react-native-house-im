...
import static com.reactlibrary.core.IMConstant.MessageKey.CONVERSATION_ID;
...
public class ChatManager extends ReactContextBaseJavaModule {
     ...
     */
    @ReactMethod
    public void getUnreadMessage(ReadableMap params, Promise promise) {
        if (CheckUtil.checkParamKey(params, CONVERSATION_ID, promise)) {
            return;
        }
    ...
    public void deleteAllMessages(ReadableMap params, Promise promise) {
        if (CheckUtil.checkParamKey(params, new String[]{CONVERSATION_ID, IMConstant.MessageKey.CHAT_TYPE}, promise)) {
            return;
        }
        try {
            String conversationId = params.getString(CONVERSATION_ID);
            EMConversation.EMConversationType chatType = EasemobConverter
                    .toConversationType(params.getInt(IMConstant.MessageKey.CHAT_TYPE));
    ...
    public void loadMessages(ReadableMap params, Promise promise) {
        ...
        String conversationId = params.getString(CONVERSATION_ID);
        EMConversation.EMConversationType type = EMConversation.EMConversationType.Chat;
        if (params.hasKey(IMConstant.MessageKey.CHAT_TYPE)) {
            type = EasemobConverter.toConversationType(params.getInt(IMConstant.MessageKey.CHAT_TYPE));
        }
        String fromId = "";
        if (params.hasKey(IMConstant.MessageKey.FROM_ID)) {
            fromId = params.getString(IMConstant.MessageKey.FROM_ID);
        }
        int count = 20;
        ...
        Log.d(TAG, "loadMessages: " + list.size());
    ...
    public void deleteMessage(ReadableMap params, Promise promise) {
        if (CheckUtil.checkParamKey(params, new String[]{CONVERSATION_ID, IMConstant.MessageKey.MESSAGE_ID}, promise)) {
            return;
        }
        String conversationId = params.getString(CONVERSATION_ID);
        String messageId = params.getString(IMConstant.MessageKey.MESSAGE_ID);
        EMConversation conversation = EMClient.getInstance().chatManager().getConversation(conversationId);
    ...
    public void recallMessage(ReadableMap params, Promise promise) {
        if (CheckUtil
                .checkParamKey(params, new String[]{IMConstant.MessageKey.MESSAGE_ID}, promise)) {
            return;
        }
        String messageId = params.getString(IMConstant.MessageKey.MESSAGE_ID);
    ...
    public void updateMessageExt(ReadableMap params, Promise promise) {
        if (CheckUtil
                .checkParamKey(params, new String[]{IMConstant.MessageKey.MESSAGE_ID, "ext"}, promise)) {
            return;
        }
        try {
            String messageId = params.getString(IMConstant.MessageKey.MESSAGE_ID);
    ...
    public void insertMessage(ReadableMap params, final Promise promise) {
        if (CheckUtil
                .checkParamKey(params, new String[]{IMConstant.MessageKey.CHAT_TYPE, CONVERSATION_ID, "direction", "messageType", "body"},
                        promise)) {
            return;
        }
        try {
    ...
    public void sendMessage(final ReadableMap params, final Promise promise) {
        if (CheckUtil
                .checkParamKey(params, new String[]{IMConstant.MessageKey.CHAT_TYPE, "messageType", "to", "body"}, promise)) {
            return;
        }
        try {
    ...
    private EMMessage buildInsertMessage(ReadableMap params) {
        ...
        if (params.hasKey(IMConstant.MessageKey.MESSAGE_ID)) {
            message.setMsgId(params.getString(IMConstant.MessageKey.MESSAGE_ID));
        }
    ...
    private EMMessage buildMessage(ReadableMap params, boolean isInsert) throws JSONException {
        ...
        if (message != null) {
            message.setChatType(EasemobConverter.toChatType(params.getInt(IMConstant.MessageKey.CHAT_TYPE)));
